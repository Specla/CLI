...
module.exports = class Specla extends EventEmitter {

  /**
   * Create new instance of the Specla app
   * @param {Object} speclaConfig
   * @param {Object} expressConfig
   * @return {Specla}
   */
  constructor (config, expressConfig) {
    super()

    Specla.app = express(expressConfig)
  ...
  /**
   * Proxy the express.use function
   */
  use (...args) {
    this.app.use(...args)
    return this
  ...
  /**
   * Proxy the express.listen method
   */
  listen (...args) {
  ...
  /**
   * Proxy the express.delete method
   */
  delete (...args) {
  ...
  /**
   * Proxy the express.param method
   */
  param (...args) {
    this.app.param(...args)
    return this
